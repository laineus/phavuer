...
Phaser 4's GameObjects and their properties are used as components and props, respectively.  

\*\*\* **Attention** \*\*\*

- Currently, it supports basic Phaser functionality and major GameObjects, but not all of them.
- Note that performance is not guaranteed, and it will not be faster than using Phaser alone.
- Using Phavuer significantly changes your code structure compared to standard Phaser. Please note that switching between the two is not straightforward.
