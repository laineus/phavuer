...
Get current instance of [Phaser.Game](https://newdocs.phaser.io/docs/3.90.0/Phaser.Game)
...
Get current Instance of [Phaser.Scene](https://newdocs.phaser.io/docs/3.90.0/Phaser.Scene)
